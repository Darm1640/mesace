...
class as_kardex_productos_wiz(models.TransientModel):
    ...
    product_brand_id = fields.Many2many('as.product.brand', string="Marca")
    as_tipo_producto = fields.Selection([('Ambos','Ambos'),('Productos','Productos'),('AF','AF'),('activos','Activo Inicial')],string="Tipo de Producto")
    ...
    def export_xlsx(self):
        ...
        if context.get('xlsx_export'):
            return self.env.ref('as_bo_stock.kardex_productos_xlsx').report_action(self, data=datas)
...
from . import as_reporte_existencias_clon


class as_kardex_productos_excel(models.AbstractModel):
    _name = 'report.as_bo_stock.kardex_variants_report_xls.xlsx'
    _inherit = 'report.report_xlsx.abstract'

    def generate_xlsx_report(self, workbook, data, lines):   
        if data['form']['as_reporte_existencias']:
            as_reporte_existencias_clon.generate_xlsx_report3(self, workbook, data, lines)
        ...
        #     as_reporte_existencias_diff.generate_xlsx_report3(self, workbook, data, lines)
            ...
            sheet.merge_range('A4:L4', 'KARDEX DE VARIANTES', titulo1)
                ...
                for producto in product_categories:
                    ...
                    query_movements = ("""
                        SELECT
                            ...
                            ,COALESCE((sp.date_done::TIMESTAMP+ '-4 hr')::date, (sm.date::TIMESTAMP+ '-4 hr')::date) as "Fecha"
    ...
    def get_saldo_entrada(self,product,almacen,fecha):
        ...
        query_movements = ("""
            ...
            WHERE
                ...
                AND sm.date::date <= '"""+str(ultimo_dia_year)+"""'

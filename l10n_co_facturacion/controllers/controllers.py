...
class KumbalFacturacionElectronicaCo(http.Controller):
    ...
    def approve_fe(self, token, approved, **kwargs):
        ...
        if invoice.fe_approved != 'sin-calificacion':
            ...
            return request.render('l10n_co_factura.invoice_already_approved', {
        ...
        return request.render('l10n_co_factura.approve_fe_invoice_submit', {
            'approved': approved,
            'invoice': invoice,
            'token': token,    
        })
    ...
    def feedback_fe(self, token, **kwargs):
        ...
        return request.render('l10n_co_factura.fe_feedback_submitted', {

...
class HrUVTValueRangeRF(models.Model):
    ...
    value_uvt_max = fields.Integer(
        string="Value UVT Max", required=True, tracking=True)
    uvt_discount = fields.Integer(
        string="UVT Discount", required=True, tracking=True)
    marginal_rate = fields.Float(
        string="Marginal Rate", required=True, tracking=True)
    uvt_additional = fields.Integer(
        string="UVT Additional", required=True, tracking=True)
...
class HrUVTValueRF(models.Model):
    ...
    value = fields.Float(
        string="Value", required=True, tracking=True)

...
class MrpConfirmation(models.TransientModel):
    ...
    def _compute_move_lines(self):
        ...
        if self.workorder_id.move_raw_ids:
    ...
    def _compute_byproducts_move_lines(self):
        ...
        if self.workorder_id.move_finished_ids:
    ...
    def onchange_workorder_id(self):
        if self.workorder_id.prev_work_order_id.date_actual_finished_wo:
            ...
            self.date_start = self.workorder_id.date_planned_start_wo or self.production_id.date_start or fields.Datetime.now()
        ...
        for record in self:
            ...
            if record.workorder_id:
                if record.qty_producing == 0.0:
                    ...
                    record.production_id._apply_update_workorder_lines()
                for move in record.workorder_id:
                ...
                byproducts_stock_moves = record.workorder_id.move_finished_ids - finished_product_move_line

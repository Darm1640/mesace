...
class AssetDepreciationConfirmationWizard(models.TransientModel):
    _name = "as.asset.depreciation.confirmation.wizard"
    _description = "as.asset.depreciation.confirmation.wizard"
    ...
    def asset_compute(self):
        ...
        created_move_ids = self.env['account.asset.asset'].compute_generated_entries_category(self.date, asset_type=context.get('asset_type'),active_ids=tuple(self._context['active_ids']))

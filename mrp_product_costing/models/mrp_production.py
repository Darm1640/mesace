...
class MrpProduction(models.Model):
    ...
    def _post_inventory(self, cancel_backorder=False):
        for order in self:
            ...
            super(MrpProduction, order)._post_inventory()
    ...
    @api.depends('product_id','bom_id', 'cur_std_byproduct_amount')
    def calculate_planned_costs(self):
        ...
        for production in self:
            ...
            production.cur_std_lab_cost = self.bom_id.total_labour_cost or costlab

...
class hr_payslip(models.Model):
    ...
    def write(self, vals):
        ...
        if 'input_line_ids' in vals and 'expense_sheet_ids' not in self._fields.keys():
        ...
        for payslip in self:
            ...
            for had in payslip.alw_ded_ids:
                input_lines_vals.append((0, 0, {
                    'amount': had.amount,
                    'name': had.hr_payslip_input_type_id.name,
                    'descripcion':had.hr_payslip_input_type_id.name,
